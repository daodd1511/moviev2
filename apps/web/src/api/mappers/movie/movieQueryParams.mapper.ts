...
export namespace MovieQueryParamsMapper {
  ...
  export function toDto(params: MovieQueryParams): MovieQueryParamsDto {
    ...
    const releaseDateGteValue =
      params.releaseDateGte !== undefined ? params.releaseDateGte.toISOString() : '';
    const releaseDateLteValue =
      params.releaseDateLte !== undefined ? params.releaseDateLte.toISOString() : '';
