...
import { FIELD_GROUP_SURFACE } from '@/lib/fieldStyles';
...
const InputGroup = ({ className, ...props }: React.ComponentProps<'div'>) => (
  <div
    ...
    className={cn(
      FIELD_GROUP_SURFACE,
      'group/input-group relative flex h-11 w-full min-w-0 items-center in-data-[slot=combobox-content]:focus-within:border-inherit has-[>[data-align=block-end]]:h-auto has-[>[data-align=block-end]]:flex-col has-[>[data-align=block-start]]:h-auto has-[>[data-align=block-start]]:flex-col has-[>textarea]:h-auto has-[>[data-align=block-end]]:[&>input]:pt-3 has-[>[data-align=block-start]]:[&>input]:pb-3 has-[>[data-align=inline-end]]:[&>input]:pr-1.5 has-[>[data-align=inline-start]]:[&>input]:pl-1.5',
      className,
    )}
    {...props}
  />
